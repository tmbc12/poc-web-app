...
const SingleProductPage = () => {
  return (
    <div className=' container mx-auto pl-20'>
      <h1 className=' text-white text-2xl mt-6  w-[40%]'>Men Checkered Round Neck Cotton Blend Black T-Shirt</h1>
      <div className=' flex gap-8 h-60  max-sm:pl-4 mt-10'>
      ...
      <div className=' flex  mt-9 max-sm:pl-0 max-sm:p-3'>
        <Tabs />
      </div>
